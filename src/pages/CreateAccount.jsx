        ...
        <div className="createAccount">
            <div className="form-container">
                ...
                <form action className="form">
                    <div>
                        <label htmlFor="createAccount__name" className="label label--name">Name</label>
                        <input type="text" className="input input--name" placeholder="Your name" id="createAccount__name" />
                        <label htmlFor="createAccount__email" className="label label--email">Email address</label>
                        <input type="email" className="input input--email" placeholder="youremail@gmail.com" id="createAccount__email" />
                        <label htmlFor="createAccount__password" className="label label--password">Password</label>
